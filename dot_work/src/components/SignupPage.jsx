  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-6">
      <div className="flex max-w-5xl w-full rounded-3xl shadow-lg overflow-hidden">
        {/* Left Part */}
        <div className="flex flex-col justify-between bg-indigo-400 px-12 py-10 w-6/12 rounded-l-3xl text-white">
          <div>
          ...
          <div className="relative">
            ...
            <div className="flex items-center space-x-4">
              {/* <div className="bg-indigo-600 rounded-md p-2 flex flex-col items-center justify-center w-20 h-24">
                <img
                  src="https://cdn-icons-png.flaticon.com/512/236/236832.png" // placeholder computer icon
                  alt="computer"
                  className="w-10 h-10 mb-1"
                />
                <div className="bg-indigo-800 w-16 h-2 rounded-md" />
              </div> */}
              {/* <div className="bg-indigo-700 rounded-full w-16 h-16 flex items-center justify-center relative text-indigo-100 font-bold text-lg">
                👨‍💻
                <span className="absolute top-0 right-0 bg-indigo-800 rounded-full px-1 text-xs">
                  ✌️
                </span>
              </div> */}
            </div>
            ...
            {/* Floating objects */}
            {/* <img
              src="https://cdn-icons-png.flaticon.com/512/633/633600.png" // rocket
              alt="rocket"
              className="absolute top-0 right-16 w-12 h-12 animate-bounce"
              style={{ transform: "rotate(15deg)" }}
            /> */}
            {/* <img
              src="https://cdn-icons-png.flaticon.com/512/2913/2913099.png" // book
              alt="book"
              className="absolute top-28 left-12 w-12 h-12 animate-pulse"
              style={{ transform: "rotate(-10deg)" }}
            /> */}
            {/* <img
              src="https://cdn-icons-png.flaticon.com/512/2913/2913085.png" // plant pot
              alt="plant"
        ...
        <div className="bg-white p-10 rounded-3xl shadow-md relative border border-red-600">
          ...
          <form>
            ...
            <label className="block mb-6 text-gray-700 text-sm font-medium relative">
              Password
              <input
            ...
            <button
              ...
              className={`w-full py-3 rounded-full text-white font-semibold ${
                agreed ? "bg-indigo-600 hover:bg-indigo-700" : "bg-indigo-300 cursor-not-allowed"
